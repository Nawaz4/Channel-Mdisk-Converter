...
API_ID = int(os.environ.get("API_ID", "24985119"))
API_HASH = os.environ.get("API_HASH", "f7ea3501d9fd57f1823d652f3919ff88")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6026109242:AAEirSszMVF-J5hXUrB3eK6TfVQip4jK6BM")
DROPLINK_API = os.environ.get("DROPLINK_API")
MDISK_API = os.environ.get("MDISK_API", "CNLVTK8FsEFhnfDpHtYC")
ADMINS = list(int(i.strip()) for i in os.environ.get("ADMINS").split("5260500114")) if os.environ.get("ADMINS") else []
DATABASE_NAME = os.environ.get("DATABASE_NAME", "MdiskConvertorBotpro")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://reditor:reditor@cluster0.pv9p33d.mongodb.net/?retryWrites=true&w=majority")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001852948732")) if os.environ.get("CHANNEL_ID") else []
